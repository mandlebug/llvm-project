...
// RUN: %clang_cc1 -fopenmp -fopenmp-version=50 -x c -triple x86_64-apple-darwin10 -target-cpu core2 -include-pch %t -Wno-tentative-definitions -verify %s -emit-llvm -o - | FileCheck --check-prefix=CHECK --check-prefix=CHECK-50 %s
...
// RUN: %clang_cc1 -fopenmp-simd -fopenmp-version=50 -x c -triple x86_64-apple-darwin10 -target-cpu core2 -include-pch %t -Wno-tentative-definitions -verify %s -emit-llvm -o - | FileCheck --check-prefix SIMD-ONLY0 %s
...
// RUN: %clang_cc1 -fopenmp -x c -triple x86_64-apple-darwin10 -target-cpu core2 -include-pch %t -Wno-tentative-definitions -verify %s -emit-llvm -o - | FileCheck %s
...
// RUN: %clang_cc1 -fopenmp-simd -x c -triple x86_64-apple-darwin10 -target-cpu core2 -include-pch %t -Wno-tentative-definitions -verify %s -emit-llvm -o - | FileCheck --check-prefix SIMD-ONLY0 %s
